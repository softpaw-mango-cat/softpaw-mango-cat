> **tldr: ссылки**  
> [Стэк](#-стэк) [Проекты](#-проекты) [Образование](#-образование) [Контакты](#-контакты)  

![Adventure banner](images/cat_img.png)
---


🐈 Привет! Меня зовут Катя, я начинающая тестировщица и перехожу в эту сферу из техподдержки (10 лет опыта в самых разных проектах). Мне всегда нравилось разбираться в проблемах продукта и понимать, как всё устроено. После нескольких лет работы в области онлайн-образования и поисков себя в разных айтишных занятиях я поняла, что именно тестирование — это то, чем я хочу заниматься дальше.
...
🎲 Среди моих увлечений - настолки (dnd, mtg), крафт, видеоигры, немного кэмпинг, автопутешествия. А в профессиональном плане мне хочется в ближайшем будущем стать частью команды разработки крутого продукта, где я смогу развиваться в тестировании, автоматизации, учиться у коллег и вносить свой вклад в создание надёжного и качественного ПО.
...
### [Проект #3: Тестирование API Swagger Petstore](https://github.com/softpaw-mango-cat/petstore-api)

- [Описание проекта](https://github.com/softpaw-mango-cat/petstore-api/blob/main/README.md)
- [Коллекции Postman](https://github.com/softpaw-mango-cat/petstore-api/tree/main/postman)
...
✔️ **Инженер по тестированию | Автотесты на Java** <br>
...
Это был мой первый шаг в изучении тестирования. Познакомилась с теорией тестирования, тест-дизайном и документацией, API, БД, тестированием веб и мобильных приложений. <br>
...
Дополнительный курс по углублению в техники тест-дизайна. Изучила и применяла техники классов эквивалентности, граничных значений, их совокупности и поработала с таблицей принятия решений. <br>
